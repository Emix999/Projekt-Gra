...
const ziemniak = new przedmiot("Pyra", "Ulubione warzywo każdego wielkopolanina. Co turę odzyskujesz 3 sanity z samego faktu, że go posiadasz, a po zjedzeniu odzyskujesz 50 sanity.", 'grafiki/przedmioty/ziemniak.png', 50);
const rozwiazana_kartkowka = new przedmiot('Rozwiązana kartkówka', 'Pokazuje ci, która odpowiedź jest poprawna na kartkówce.', 'grafiki/przedmioty/kartkowka.png', 0, 0, () => sciagaj());
const obiadek = new przedmiot('Obiadek', 'Najwyższej jakości posiłek, którym sam prezydent by nie pogardził. Po zjedzeniu odzyskuje 35 sanity', 'grafiki/przedmioty/obiadek.png', 35, 24);
...
const woda = new przedmiot('Woda', 'Sprawia, że twój mózg pracuje szybciej – usuwa 1 błędną odpowiedź z kartkówki.', 'grafiki/przedmioty/woda.png', 0, 0, () => usun_odpowiedzi(1));
const herbata = new przedmiot('Herbata', 'Sprawia, że twój mózg pracuje na najwyższych obrotach – usuwa 2 błędne odpowiedzi z kartkówki.', 'grafiki/przedmioty/termos.jpg', 0, 0, () => usun_odpowiedzi(2));
const kawa = new przedmiot('Kawa', 'Może pobudzić twój mózg... albo i nie. Usuwa 0, 1 lub 2 błędne odpowiedzi z kartkówki', 'grafiki/przedmioty/kawa.png', 0, 0, () => losowe_usun_odpowiedzi(0, 2));
const uzaleznienie = new przedmiot("Uzależnienie", "Co turę twoje sanity zmienia się losowo od -5 do 3. Próba odinstalowania tiktoka kończy się strasznym bólem mózgu i tracisz 100 sanity", 'grafiki/przedmioty/toktik.png', -100);
const pierog = new przedmiot('Pieróg', 'Smak tej niesamowitej potrawy sprawia, że twój mózg działa o wiele sprawniej – usuwa 2 lub 3 błędne odpowiedzi z kartkówki.', 'grafiki/przedmioty/Pieróg.png', 0, 0, () => losowe_usun_odpowiedzi(2, 3));
