...
function zmien_pietro(mapa_znikajaca, mapa_pojawiajaca, zdarzenie){
    znikniecie_ekranu(mapa_znikajaca);
    pokaz_zdarzenie(mapa_pojawiajaca, zdarzenie);
...
for(let przycisk of mapa_przyciski){
    przycisk.addEventListener('click', () => zmien_pietro(przycisk.parentElement.parentElement, document.getElementById(przycisk.dataset.mapa), zdarzenie_testowe));
}
...
function pokaz_zdarzenie(mapa_pojawiajaca, zdarzenie){
    ...
    przejdz_dalej2.dataset.mapa = mapa_pojawiajaca.id;
}

function zniknij_zdarzenie(){
    zmiana_ekranu(ekran_zdarzenia, mapa);
    pojawienie_ekranu(ekran_gry);
    pojawienie_ekranu(document.getElementById(przejdz_dalej2.dataset.mapa));
}
