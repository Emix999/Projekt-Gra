...
const zmiana_w_planie_lekcji2 = new zdarzenie('Zmiana w planie lekcji', 'Dzisiaj odwołali ci 3 ostatnie lekcje. Ktoś w sekretariacie musiał mieć dobry dzień — dzięki temu wracasz do domu o 12.00. W klasie panuje ogólna radość. Zyskujesz 10 sanity.', 30, () => zmiana_sanity2(10));
const wycieczka = new zdarzenie('Wycieczka', 'Nie ma lekcji, tylko autobus, słuchawki i fajnie spędzony czas z kolegami. Życie jest piękne. Zyskujesz 30 sanity.', 10, () => zmiana_sanity2(30));
...
const to_bolalo = new zdarzenie('To bolało!', 'W pośpiechu ślizgasz się na rozlanym napoju. Lądujesz na ziemi jak worek ziemniaków, obiłeś się i ośmieszyłeś. Tracisz 10 sanity.', 40, () => zmiana_sanity2(-10));
const chmura_dymu = new zdarzenie('Kolejka', 'Otwierasz drzwi do toalety... i nagle widzisz kolejkę sięgającą drzwi wejściowych. Akurat teraz wszyscy tu przyszli. Stoisz w kolejce. Tracisz 2 sanity.', 125, () => zmiana_sanity2(-2));
const uwaga = new zdarzenie('Uwaga', 'Jesteś na lekcji z najsurowszą nauczycielką, a tu nagle - PING z messengera. Nauczycielka wpatruje się w ciebie wzrokiem, który mógłby topić stal. Czujesz już tą uwagę w dzienniku. Tracisz 5 sanity.', 75, () => zmiana_sanity2(-5));
const smierc = new zdarzenie('Koszmarny program', "Psujesz XAMPP'a w sali 102b. Czeka cię surowa kara i gniew nauczycielki. Tracisz ∞ sanity.", 1, () => zmiana_sanity2(-200));
...
const zmiana_nauczyciela = new zdarzenie('Zmiana nauczyciela', 'Wasza ulubiona nauczycielka od angielskiego została zwolniona, i w zamian niej przyszła nowa "inna" nauczycielka. Jeszcze wczoraj były żarty i luz, dziś nowa pani od angielskiego wprowadza „nowe zasady” i rozdaje kartkówki na wejściu do sali. Wszyscy gracze tracą 20 sanity.', 20, () => wszyscy_zmiana_sanity(-20));
...
const posmiewisko = new zdarzenie('Pośmiewisko', 'Na grupie klasowej pojawia się bardzo śmieszny mem. Grupowa beka z konkurencyjnej szkoły. Sypią się żarty, komentarze, a śmiech unosi się nad Messengerem. Odzyskujesz 20 sanity.', 15, () => zmiana_sanity2(20));
...
const skarb_zycia = new zdarzenie('Skarb życia', 'Na środku korytarza dostrzegasz niesamowitą bulwę pyry. Twoje wielkopolskie serce przepełnia się radością. To nie jest zwykła pyra. To symbol tradycji, siły i obiadu. Czujesz, jak energia pyry wypełnia cię DETERMINACJĄ.', 1, () => dodawanie_przedmiotu_do_ekwipunku(ziemniak));
...
const dziwne_znalezisko = new zdarzenie('Dziwne znalezisko', 'W koszu na śmieci znajdujesz... pierogi? Bluźnierstwo. Jak ktoś mógł wyrzucić skarb polskiej kuchnii? Przygarniasz je z czułością. Przed zjedzeniem oczywiście dokładnie je myjesz.', 1, () => dodawanie_przedmiotu_do_ekwipunku(pierog, 5));