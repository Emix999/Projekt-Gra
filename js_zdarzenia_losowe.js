...
const zmiana_w_planie_lekcji2 = new zdarzenie('Zmiana w planie lekcji', 'Dzisiaj odwołali ci 3 ostatnie lekcje. Ktoś w sekretariacie musiał mieć dobry dzień — dzięki temu wracasz do domu o 12.00. Zaczynasz podejrzewać, że nauczycielom też nie chciało się przychodzić do szkoły. Zyskujesz 10 sanity.', 30, () => zmiana_sanity2(10));
...
const skarb_zycia = new zdarzenie('Skarb życia', 'Na środku korytarza dostrzegasz niesamowitą bulwę ziemniaka. Twoje wielkopolskie serce przepełnia się radością. To nie jest zwykła pyra. To symbol tradycji, siły i obiadu. Czujesz, jak energia pyry wypełnia cię DETERMINACJĄ.', 1, () => dodawanie_przedmiotu_do_ekwipunku(ziemniak));
