...
function zmiana_sanity(zmana_sanity){
...
const zmiana_w_planie_lekcji = new zdarzenie('Zmiana w planie lekcji', 'Siedząc zrezygnowany na przedostatniej lekcji, nagle słyszysz anielskie słowa z tyłu klasy: "Ej, słuchajcie, odwołali nam ostatnią lekcję." Świat znowu ma sens. Zyskujesz 5 sanity.', 100, () => zmiana_sanity(5));
const zmiana_w_planie_lekcji2 = new zdarzenie('Zmiana w planie lekcji', 'Dzisiaj odwołali ci 3 ostatnie lekcje. Ktoś w sekretariacie musiał mieć dobry dzień — dzięki temu wracasz ko domu o 12.00. Zaczynasz podejrzewać, że nauczycielom też nie chciało się przychodzić do szkoły. Zyskujesz 10 sanity.', 30, () => zmiana_sanity(10));
const wycieczka = new zdarzenie('Wycieczka', 'Nie ma lekcji, tylko autobus, słuchawki i fajnie spędzony czas z kolegami. Życie jest piękne (do czasu powrotu). Zyskujesz 30 sanity.', 10, () => zmiana_sanity(30));
const dokonales_niemozliwego = new zdarzenie('Dokonałeś niemożliwego', 'Naprawiłeś XAMPPa w sali 102b. Nauczyciele od dwóch tygodni łamali sobie głowy, ale to ty, prosty uczeń, wskrzesiłeś martwego XAMPPa. Pani Cichowska poklepuje cię po ramieniu. Masz ochotę spisać to w CV. Zyskujesz 200 sanity i pochwałę dyrektora.', 1, () => zmiana_sanity(200));
const to_bolalo = new zdarzenie('To bolało!', 'W pośpiechu ślizgasz się na rozlanym napoju. Lądujesz na ziemi jak worek ziemniaków, a echo śmiechu kolegów zostanie z tobą na zawsze. Tracisz 10 sanity.', 40, () => zmiana_sanity(-10));
const chmura_dymu = new zdarzenie('Chmura dymu', 'Otwierasz drzwi do toalety... i nagle witasz się z chmurą nikotynowego smogu. Czujesz się jak mieszkaniec Krakowa. Tracisz 2 sanity.', 125, () => zmiana_sanity(-2));
const uwaga = new zdarzenie('Uwaga', 'Jesteś na lekcji z waszą znienawidzoną nauczycielką, a tu nagle - PING z messengera. Nauczycielka wpatruje się w ciebie wzrokiem, który mógłby topić stal. Czujesz już tą uwagę w dzienniku. Tracisz 5 sanity.', 75, () => zmiana_sanity(-5));
const smierc = new zdarzenie('Śmierć', "Psujesz XAMPP'a w sali 102b. Czeka cię publiczna egzekucja. Tracisz ∞ sanity.", 1, () => zmiana_sanity(-200));
...
const posmiewisko = new zdarzenie('Pośmiewisko', 'Na grupie klasowej obrażacie ZSK. Grupowa beka z konkurencyjnej szkoły. Sypią się żarty, komentarze, a śmiech unosi się nad Messengerem. Moralność? Czym jest moralność? Odzyskujesz 20 sanity.', 15, () => zmiana_sanity(20));
const dziwny_widok = new zdarzenie('Dziwny widok', 'Na korytarzu widzisz członków DnD (Drużyny Najgorszych Deweloperów). Spoglądasz, co robią, i widzisz, że piszą najbardziej heretyczny kod jaki kiedykolwiek widziałeś. Na ekranie: kod powtarza się 20 razy, zmienne długie na 50 znaków, a funkcje krzyczą o litość. To nie jest kod — to cyfrowe bluźnierstwo. Tracisz 50 sanity i zyskujesz ból oczu.', 1, () => zmiana_sanity(-50));
const skarb_zycia = new zdarzenie('Skarb życia', 'Na środku korytarza dostrzegasz niesamowitą bulwę ziemniaka. Twoje wielkopolskie serce przepełnia się radością. To nie jest zwykły ziemniak. To symbol tradycji, siły i obiadu. Czujesz, jak energia ziemniaka wypełnia cię DETERMINACJĄ.', 1, () => dodawnie_przedmiotu_do_ekwipunku(ziemniak));
